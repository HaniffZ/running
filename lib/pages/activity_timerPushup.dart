...
import 'dart:ui';
import 'dart:async';
import 'activity_timerLateralRaise.dart';

class ActivityPushup extends StatelessWidget {
  final String image =
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(builder: (_) {
                            return ActivityTimerLateralRaise();
                          }),
                        );
                      },
                    ),
...
class OtpTimer2 extends StatefulWidget {
  @override
  _OtpTimerState createState() => _OtpTimerState();
}

class _OtpTimerState extends State<OtpTimer2> {
